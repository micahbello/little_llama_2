...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background_background_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__animals_llama_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__other_objects_platform_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__animals_pig_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__other_objects_bacon_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__weapons_time_controller_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__background_sun_js__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__background_bird_1_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__constants_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__util_js__ = __webpack_require__(33);
...
class Game extends __WEBPACK_IMPORTED_MODULE_14__util_js__["a" /* default */] {
  constructor() {
    super();
    ...
    this.llama = new __WEBPACK_IMPORTED_MODULE_1__animals_llama_js__["a" /* default */](Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT);
...
// NOTE: General flow functions
  update(ctx) {
    ...
    this.managePigsPlatformsWhenTimeControllerIsActive();
  ...
  showSpawnCircles(ctx) {
    __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */].forEach(set => {
      ctx.beginPath();
  ...
  manageInactiveItems() {
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__["a" /* default */]) {
        if (this.itemsInPlay[i].status === "inactive") {
          ...
          if (this.itemsInPlay[i].x < __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].x + this.itemsInPlay[i].radius && this.itemsInPlay[i].y < __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].y + this.itemsInPlay[i].radius) {
        ...
        if (this.itemsInPlay[i].status === "inactive") {
          ...
          if ((bacon.x < __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].x && bacon.y < __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].y) || (bacon.x < -10) || (bacon.y < -10)) {
            this.itemsInPlay.splice(i, 1);
    ...
    for (let i = 0; i < this.coins.length; i++) {
      if (this.coins[i].status === "inactive") {
        ...
        if ((this.coins[i].x < __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].x && this.coins[i].y < __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].y) || (this.coins[i].x < -10) || (this.coins[i].y < -10)) {
  ...
  managePlatforms() {
    ...
    if (!(this.platforms.length > 12)) {
      ...
      __WEBPACK_IMPORTED_MODULE_13__constants_js__["i" /* PLATFORMTRACKS */].forEach((trackset) => {
  ...
  drawScore(ctx) {
    ...
    //coin
    ctx.drawImage(this.coinIcon, 0, 0, 35, 35, __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].x, __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].y, 26, 26);
    ctx.font = "17px Monospace";
    ctx.textAlign = "left"
    ctx.fillStyle = outlineColor
    ctx.fillText(`x ${this.scoreOnCounter}`, __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].x + 25, __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].y + 15);

    //heart
    ctx.drawImage(this.heartIcon, 0, 0, 30, 30, __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].x, __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].y, 28, 28);
    ctx.font = "17px Monospace";
    ctx.fillStyle = outlineColor;
    ctx.fillText(`x ${this.llamaHeartsOnCounter}`, __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].x + 32, __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].y + 15);

    //bacons
    ctx.drawImage(this.baconIcon, 10, 10, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].x, __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].y, 50, 50);
    ctx.font = "17px Monospace";
    ctx.fillStyle = outlineColor;
    ctx.fillText(`x ${this.baconsOnCounter}`, __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].x + 43, __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].y + 15);
  ...
  drawWeaponsContainer(ctx) {
    ...
    if (this.llama.weaponsInPossession[0]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 0) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].y - 22, 48, 48);
        }
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 0) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].y - 22, 48, 48);
        }
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_10__weapons_time_controller_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 0) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */].y - 24, 50, 50);
        }
      }
    }
    ...
    if (this.llama.weaponsInPossession[1]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 1) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].y - 22, 48, 48);
        }
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 1) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].y - 22, 58, 58);
        ...
        if (this.llama.weaponTogglePosition === 1) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */].y - 24, 50, 50);
        }
      }
    }
    ...
    if (this.llama.weaponsInPossession[2]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 2) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].y - 22, 48, 48);
        }
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 2) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].y - 22, 58, 58);
        ...
        if (this.llama.weaponTogglePosition === 2) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */].y - 24, 50, 50);
        }
      }
    }
  }
      ...
      if (llamaFront > platform.x && this.llama.x < platformFront &&  llamaBottom < platformBottom && platform.y < llamaBottom && this.llama.y_velocity > 0) {
        ...
        if (platform.direction === "right") {
          ...
          if (this.llama.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_10__weapons_time_controller_js__["a" /* default */]) {
            this.llama.x += platform.speed * __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* slowModeSpeedReducer */];
          } else {
  ...
  checkLLamaCoinCollision() {
    ...
    if ((this.llama.y < coinBottom && coin.y < llamaBottom && llamaFront > coin.x && coinFront > llamaFront) || (this.llama.y < coinBottom && coin.y < llamaBottom && this.llama.x < coinFront && llamaFront > coin.x)) {
      ...
      this.coins.push(new __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__["a" /* default */](this.createRandomCoord(0, Game.DIM_X - 25), this.createRandomCoord(0, Game.DIM_Y - Game.FLOOR_HEIGHT - 39)));
      this.score ++;
      this.yeahSound.play();
      // NOTE: Do not spawn new pigs if llama is currently using bubbleshield
      if (!(this.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__["a" /* default */])) {
        this.createNewPig();
      }
    }
  }
  ...
  resolveLlamaItemsWithDepositSpacesCollision(object) {
    ...
    if (object instanceof __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__["a" /* default */]) {
      destination.x = __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].x;
      destination.y = __WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* COINDEPOSITCOORD */].y;
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__["a" /* default */]) {
      destination.x = __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].x;
      destination.y = __WEBPACK_IMPORTED_MODULE_13__constants_js__["e" /* HEARTDEPOSITCOORD */].y;
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_6__other_objects_bacon_js__["a" /* default */]) {
      destination.x = __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].x;
      destination.y = __WEBPACK_IMPORTED_MODULE_13__constants_js__["a" /* BACONDEPOSITCOORD */].y;
    }
    // else if (object instanceof WeaponItem) {
...
// NOTE: Miscellaneous functions
  ...
  returnEmptyWeaponSlot() {
    if (this.llama.weaponsInPossession.length === 0) {
      return __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* WEAPON1COORD */];
    } else if (this.llama.weaponsInPossession.length === 1) {
      return __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON2COORD */];
    } else if (this.llama.weaponsInPossession.length === 2) {
      return __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON3COORD */];
    }
  }
  ...
  returnEmptySpawnCircle() {
    ...
    for (let i = 0; i < __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */].length; i++) {
      for (let j = 0; j < objects.length; j++) {
        if (objects[j] instanceof __WEBPACK_IMPORTED_MODULE_3__animals_pig_js__["a" /* default */]){

          if (this.areSpheresColliding({x: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][0], y: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][1], radius: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][2]}, objects[j]) && (objects[j].status === "available" || objects[j].status === "testing")) {
            circles[i] = false;
          }
        } else if (objects[j] instanceof __WEBPACK_IMPORTED_MODULE_1__animals_llama_js__["a" /* default */]) {
          if (this.areSphereNonSphereColliding({x: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][0], y: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][1], radius: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][2]}, objects[j])) {
            circles[i] = false;
          }
        } else if (objects[j] instanceof __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__["a" /* default */]) {
          if (this.areSpheresColliding({x: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][0], y: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][1], radius: __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i][2]}, objects[j])) {
            circles[i] = false;
          }
        }
      }
    ...
    for (let i = 0; i < circles.length; i++) {
      if (circles[i] === true) {
        return __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][i];
      }
    }

    return __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* SPAWNCIRCLES */][0];
  }
  ...
  spawnNewWeaponItem() {
    let randomDayWeapons = ["forceFieldBlast", "timeController"];
  ...
  managePigsPlatformsWhenTimeControllerIsActive() {
    let pigLimiterActive =  this.llama.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_10__weapons_time_controller_js__["a" /* default */];

    let objects = this.platforms.concat(this.itemsInPlay).concat(this.coins).concat(this.background.luminary).concat(this.background).concat(this.background.meteor).concat(this.background.bird);
      ...
      if (pigLimiterActive) {
        if (object instanceof __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__["a" /* default */] || object instanceof __WEBPACK_IMPORTED_MODULE_12__background_bird_1_js__["a" /* default */]) {
          if (!object.spritecycleOffsetForSlowMode) {
            object.spritecycle = object.spritecycle / __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* slowModeSpeedReducer */];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_js__ = __webpack_require__(31);
...
class WeaponItem {
  ...
  move() {
    if (this.status === "available") {
      if (this.slowMode) {
        this.x += this.x_velocity * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
        this.y += this.y_velocity * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
      } else {
...
class Bird1 {
  ...
  move() {
    if (this.slowMode) {
      this.x = this.x - .5 * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
    } else {
      this.x = this.x - .5;
    }
  }
  ...
  getSprite() {
    ...
    let framesUntilNextSpriteSlowMode = 3 / __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
...
class Meteor {
  ...
  move() {
    if (this.slowMode) {
      this.y = this.y + 1 * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
      this.x = this.x - 1 * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
    } else {
      this.y = this.y + 1;
      this.x = this.x - 1;
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__weapons_forcefield_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__weapons_bubble_shield_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__weapons_time_controller_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constants_js__ = __webpack_require__(31);
...
class Llama {
  ...
  getSprite() {
    ...
    if (this.status === "dead") {
      ...
      return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].dead;
    }
    ...
    if (!this.keysPressed[37] && !this.keysPressed[39] && this.jumping === false) {
      ...
      if (this.lastDirectionFaced === "right") {
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].rightPosition1
      } else if (this.lastDirectionFaced === "left") {
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].leftPosition1
      }
    }
    ...
    if (this.keysPressed[37]) {
      ...
      if (this.walkcycle < 6) {
        ...
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].leftPosition2
      } else if (this.walkcycle < 18) {
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].leftPosition3
      } else if (this.walkcycle < 24) {
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].leftPosition4
      } else {
        this.walkcycle = 0;
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].leftPosition1
      }
      ...
      if (this.walkcycle < 6) {
        ...
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].rightPosition2
      } else if (this.walkcycle < 18) {
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].rightPosition3
      } else if (this.walkcycle < 24) {
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].rightPosition4
      } else {
        this.walkcycle = 0;
        return __WEBPACK_IMPORTED_MODULE_3__constants_js__["g" /* LLAMA_SPRITES */].rightPosition1
      }
...
class Platform {
  constructor(direction, trackNumber, x, y, speed) {
    ...
    this.height = 22;
    this.width = 124;
    this.reducedSpeed = this.speed * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
    this.slowMode = false;
  ...
  move() {
    ...
    if (this.direction === "right") {
      if (this.slowMode) {
        this.x += this.speed * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
      } else {
        this.x += this.speed;
      }
    } else {
...
class Pig {
  ...
  getSprite() {
    ...
    let framesUntilNextSpriteSlowMode = framesUntilNextSprite / __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];

    if (this.slowMode) {
      if (this.spritecycle < framesUntilNextSpriteSlowMode) {
        return this.direction === "right" ? __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].rightPosition1 : __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].leftPosition1
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 2) {
        return this.direction === "right" ? __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].rightPosition2 : __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].leftPosition2
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 3) {
        return this.direction === "right" ? __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].rightPosition3 : __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].leftPosition3
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 4) {
        return this.direction === "right" ? __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].rightPosition4 : __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].leftPosition4
      } else {
        this.spritecycle = 0;
        return this.direction === "right" ? __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].rightPosition1 : __WEBPACK_IMPORTED_MODULE_0__constants_js__["h" /* PIG_SPRITES */].leftPosition1
      }
...
class Coin {
  ...
  getSprite() {
    ...
    let framesUntilNextSpriteSlowMode = 8 / __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];

    if (this.slowMode) {
      if (this.spritecycle < framesUntilNextSpriteSlowMode * 1) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position1;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 2) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position2;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 3) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position3;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 4) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position4;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 5) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position5;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 6) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position6;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 7) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position7;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 8) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position8;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 9) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position9;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 10) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position10;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 11) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position11;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 12) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position12;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 13) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position13;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 14) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position14;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 15) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position15;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 16) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position16;
      } else {
        this.spritecycle = 0;
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["d" /* COIN_SPRITES */].position1;
      }
...
class Heart {
  ...
  getSprite() {
    ...
    if (this.slowMode) {
      if (this.spritecycle < framesUntilNextSpriteSlowMode) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["f" /* HEART_SPRITES */].number1;
      } else if (this.spritecycle < framesUntilNextSpriteSlowMode * 2) {
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["f" /* HEART_SPRITES */].number2;
      } else {
        this.spritecycle = 0;
        return __WEBPACK_IMPORTED_MODULE_0__constants_js__["f" /* HEART_SPRITES */].number1;
      }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__luminary_js__ = __webpack_require__(32);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sun_js__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__moon_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bird_1_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__meteor_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constants_js__ = __webpack_require__(31);
...
class Background {
  ...
  scrollImage() {
    if (this.slowMode) {
      this.cloudsX = this.cloudsX - .2 * __WEBPACK_IMPORTED_MODULE_4__constants_js__["n" /* slowModeSpeedReducer */];
      this.starrySkyX = this.starrySkyX - .04 * __WEBPACK_IMPORTED_MODULE_4__constants_js__["n" /* slowModeSpeedReducer */];
    } else {
...
/* harmony export (immutable) */ __webpack_exports__["n"] = slowModeSpeedReducer;
...
/* harmony export (immutable) */ __webpack_exports__["g"] = LLAMA_SPRITES;
...
/* harmony export (immutable) */ __webpack_exports__["h"] = PIG_SPRITES;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = COIN_SPRITES;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = HEART_SPRITES;
...
/* harmony export (immutable) */ __webpack_exports__["i"] = PLATFORMTRACKS;
...
/* harmony export (immutable) */ __webpack_exports__["j"] = SPAWNCIRCLES;


const COINDEPOSITCOORD = {x: 10, y: 5};
/* harmony export (immutable) */ __webpack_exports__["c"] = COINDEPOSITCOORD;

const HEARTDEPOSITCOORD = {x: 95, y: 5};
/* harmony export (immutable) */ __webpack_exports__["e"] = HEARTDEPOSITCOORD;
...
/* harmony export (immutable) */ __webpack_exports__["k"] = WEAPON1COORD;

const WEAPON2COORD = {x: 657.5, y: 26};
/* harmony export (immutable) */ __webpack_exports__["l"] = WEAPON2COORD;

const WEAPON3COORD = {x: 713.5, y: 26};
/* harmony export (immutable) */ __webpack_exports__["m"] = WEAPON3COORD;
...
class Luminary {
  ...
  move() {
    if (this.slowMode) {
      this.x = this.x + (.09 * 2) * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
      this.y = this.y + (.05 * 2) * __WEBPACK_IMPORTED_MODULE_0__constants_js__["n" /* slowModeSpeedReducer */];
    } else {
      this.x = this.x + (.09 * 2);
      this.y = this.y + (.05 * 2);
    }
