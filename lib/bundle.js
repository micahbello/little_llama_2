...
// if (document.location.pathname.split("/").includes("mode-selection.html")) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    gameView = new __WEBPACK_IMPORTED_MODULE_0__game_view_js__["a" /* default */](ctx, demo);
    gameView.animate();
  });
...
// NOTE: normal mode start
  document.getElementById("normal-button").addEventListener("click", () => {
    ...
    gameView = new __WEBPACK_IMPORTED_MODULE_0__game_view_js__["a" /* default */](ctx, new __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */]("normal", "normal-play"));
    gameView.animate();
  });
...
// NOTE: flight mode start
  document.getElementById("flight-button").addEventListener("click", () => {
    ...
    gameView = new __WEBPACK_IMPORTED_MODULE_0__game_view_js__["a" /* default */](ctx, new __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */]("flightMode", "normal-play"));
    gameView.animate();
  });
...
// NOTE: Pause button
  ...
  document.getElementById("restart-button").addEventListener("click", () => {
    ...
    gameView = new __WEBPACK_IMPORTED_MODULE_0__game_view_js__["a" /* default */](ctx, new __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */]("normal", "background-demo"));
    gameView.animate();
  });
