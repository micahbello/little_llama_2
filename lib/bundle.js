...
const WEAPON3COORD = {x: 710.5, y: 26};
...
// NOTE: General flow functions
  update(ctx) {
    ...
    // this.manageWeaponItemsToContainer();
  ...
  // manageWeaponItemsToContainer() {
  //   for (let i = 0; i < this.itemsInPlay.length; i++) {
  //     if (this.itemsInPlay[i].status === "toContainer") {
  //       if (this.itemsInPlay[i].y < 27 ) {
  ...
  resolveLlamaItemsWithDepositSpacesCollision(object) {
    ...
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */]) {
      object.status = "toContainer";
    }
...
"use strict";
// NOTE: weapon_items have 4 statuses "available", "equipped", "unequipped"
//"available" means it is flyign around waiting to be collected,
//"equipped" meaning llama has it ready for use
//"unequipped" for llama is not ready to use it
