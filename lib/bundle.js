...
class Game {
  constructor() {
    ...
    // this.coins = [new Coin(650, 400)];
    // this.pigs = [new Pig(700, 400, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT)];
    this.pigs = [new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT), new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT), new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT), new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT)];
  ...
  manageInactiveItems() {
    ...
    for (let i = 0; i < this.coins.length; i++) {
      if (this.coins[i].status === "inactive") {
        if (this.coins[i].x < COINDEPOSITCOORD.x && this.coins[i].y < COINDEPOSITCOORD.y) {
    ...
    for (let i = 0; i < this.pigs.length; i++) {
      for (let j = 0; j < this.pigs.length; j++) {
        if (this.pigs[i] != this.pigs[j]) {
          ...
          if (this.pigs[i].status === "active" && this.pigs[j].status === "active") {
