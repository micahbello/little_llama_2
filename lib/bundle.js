...
if (document.location.pathname.split("/").includes("mode-selection.html")) {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    new __WEBPACK_IMPORTED_MODULE_0__game_view_js__["a" /* default */](ctx, demo).animate();
  });
}
...
if (document.location.pathname.split("/").includes("normal-mode-game.html")) {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    canvasEl.width = __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */].DIM_X;
    canvasEl.height = __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */].DIM_Y;
    const game = new __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */]("normal");
...
if (document.location.pathname.split("/").includes("flight-mode-game.html")) {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    canvasEl.width = __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */].DIM_X;
    canvasEl.height = __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */].DIM_Y;
    const game = new __WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */]("flightMode");
    new __WEBPACK_IMPORTED_MODULE_0__game_view_js__["a" /* default */](ctx, game).animate();
  });
}
