...
class Game {
  constructor() {
    ...
    this.itemsInPlay = [new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"),new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT), new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 100, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"), new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 50, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast") ];
    ...
    // new WeaponItem(300, 100, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"), new WeaponItem(300, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast")
    ]
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      ...
      if (this.itemsInPlay[i].status === "available") {
        ...
        if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */]) {
          ...
          if (this.areSphereNonSphereColliding(this.itemsInPlay[i], this.llama)) {
            // this.resolveLlamaItemsWithDepositSpacesCollision(this.itemsInPlay[i]);
            // this.itemsInPlay[i].x_velocity = 0;
            // this.itemsInPlay[i].y_velocity = 0;
            // this.itemsInPlay[i].x = 100;
            // this.itemsInPlay[i].y = 100;
            // this.itemsInPlay[i].status = "unequipped";
