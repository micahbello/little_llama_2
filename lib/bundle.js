...
// NOTE: General flow functions
  ...
  manageWeaponItemsSpawing() {
    if (this.weaponsSpawnCycle < 900) { // 900/60 = 15 second cycle
      ...
      if (this.llama.weaponsInPossesion.length < 3) {
...
// NOTE: Miscellaneous functions
  ...
  spawnNewWeaponItem() {
    ...
    if (this.llama.status === "normal") {
      ...
      this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](randomDayWeapons[randomIndex]));
