...
// NOTE: General flow functions
  ...
  drawScore(ctx) {
    ...
    ctx.font = "16px Monospace";
    ctx.fillStyle = "black";
    ctx.fillText(`x ${this.score}`, COINDEPOSITCOORD.x + 35, COINDEPOSITCOORD.y + 15);


    ctx.drawImage(this.heartIcon, 0, 0, 30, 30, HEARTDEPOSITCOORD.x, HEARTDEPOSITCOORD.y, 30, 30);
    ctx.font = "16px Monospace";
    ctx.fillStyle = "black";
    ctx.fillText(`x ${this.llama.hearts}`, HEARTDEPOSITCOORD.x + 35, HEARTDEPOSITCOORD.y + 15);

    // document.getElementsByClassName("total-hearts")[0].innerHTML = `x ${this.llama.hearts}`;
  }
