...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bacon_js__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__sun_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__sun_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__sun_js__);
...
class Game {
  constructor() {
    ...
    this.coins = [new __WEBPACK_IMPORTED_MODULE_4__coin_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300))];
    this.platforms = [];
    this.itemsInPlay = [];
...
// NOTE: General flow functions
  update(ctx) {
    ...
    if (this.background.luminary instanceof __WEBPACK_IMPORTED_MODULE_11__sun_js__["default"]) {
  ...
  manageInactiveItems() {
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_5__heart_js__["a" /* default */]) {
      ...
      } else if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */]) {
        if (this.itemsInPlay[i].status === "inactive") {
      ...
      } else if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */]) {
  ...
  drawScore(ctx) {
    let outlineColor = this.background.luminary instanceof __WEBPACK_IMPORTED_MODULE_11__sun_js__["default"] ? "black" : "white"
    ...
    for (let i = 0; i < sphericalObjects.length; i++) {
      for (let j = 0; j < sphericalObjects.length; j++) {
        if (sphericalObjects[i] != sphericalObjects[j]) {
          ...
          if (sphericalObjects[i] instanceof __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */] || sphericalObjects[j] instanceof __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */]) {
  ...
  checkLLamaCoinCollision() {
    ...
    if ((this.llama.y < coinBottom && coin.y < llamaBottom && llamaFront > coin.x && coinFront > llamaFront) || (this.llama.y < coinBottom && coin.y < llamaBottom && this.llama.x < coinFront && llamaFront > coin.x)) {
      ...
      this.coins.push(new __WEBPACK_IMPORTED_MODULE_4__coin_js__["a" /* default */](this.createRandomCoord(0, Game.DIM_X - 25), this.createRandomCoord(0, Game.DIM_Y - Game.FLOOR_HEIGHT - 39)));
      this.score ++;
      this.yeahSound.play();
  ...
  resolveLlamaItemsWithDepositSpacesCollision(object) {
    ...
    if (object instanceof __WEBPACK_IMPORTED_MODULE_4__coin_js__["a" /* default */]) {
    ...
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */]) {
  ...
  checkPigAndItemsInPlayPlatformCollision() {
    ...
    for (let i = 0; i < this.platforms.length; i++) {
      for (let j = 0; j < objects.length; j++) {
        ...
        if (object instanceof __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */]) {
          continue;
        }
  ...
  checkLlamaItemsInPlayCollision() {
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      ...
      if (this.itemsInPlay[i].status === "available") {
        ...
        if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */]) {
          ...
          if (currentActivatedWeapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
            if (this.areSpheresColliding(currentActivatedWeapon, this.itemsInPlay[i])) {
              ...
              if (this.itemsInPlay[i].type != "normal") {
                this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */](this.itemsInPlay[i].x - this.itemsInPlay[i].radius, this.itemsInPlay[i].y - this.itemsInPlay[i].radius, Game.DIM_Y - Game.FLOOR_HEIGHT));
                this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_5__heart_js__["a" /* default */](this.itemsInPlay[i].x - this.itemsInPlay[i].radius, this.itemsInPlay[i].y - this.itemsInPlay[i].radius, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT));
              } else {
                this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_6__bacon_js__["a" /* default */](this.itemsInPlay[i].x - this.itemsInPlay[i].radius, this.itemsInPlay[i].y - this.itemsInPlay[i].radius, Game.DIM_Y - Game.FLOOR_HEIGHT));
              }
        ...
        } else if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_5__heart_js__["a" /* default */]) {
...
// NOTE: Miscellaneous functions
  ...
  createNewPig() {
    ...
    this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](spawningCircle[0], spawningCircle[1] , Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT));
  }
  ...
  createNewSpecialPig() {
    ...
    let spawningCircle = this.returnEmptySpawnCircle();
    this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](spawningCircle[0], spawningCircle[1] , Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, availableSpecialPigs[randomIndex]));
  }

  creatNewHeart() {
    let spawningCircle = this.returnEmptySpawnCircle();
    this.itemsInPlay.push(new __WEBPACK_IMPORTED_MODULE_5__heart_js__["a" /* default */](spawningCircle[0], spawningCircle[1] , Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT));
  }
...
// NOTE: Currently not being used
  ...
  managePigsPlatformsWhenTimeControllerIsActive() {
    ...
    objects.forEach(object => {
      if (pigLimiterActive) {
        if (object instanceof __WEBPACK_IMPORTED_MODULE_4__coin_js__["a" /* default */] || object instanceof __WEBPACK_IMPORTED_MODULE_12__background_bird_1_js__["a" /* default */]) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sun_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__sun_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__moon_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__moon_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__moon_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__background_bird_1_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__background_meteor_js__ = __webpack_require__(19);
...
class Background {
  constructor(canvas_width, canvas_height) {
    ...
    this.bird = new __WEBPACK_IMPORTED_MODULE_2__background_bird_1_js__["a" /* default */]();
    this.birdCycle = 0;
    this.isBirdOnScreen = false;

    this.luminary = new __WEBPACK_IMPORTED_MODULE_0__sun_js__["default"](canvas_width, canvas_height);

    this.meteor = new __WEBPACK_IMPORTED_MODULE_3__background_meteor_js__["a" /* default */]();
    this.meteorCycle = 0;
  ...
  update(ctx) {
    ...
    if (this.luminary.y - this.luminary.radius > 302) {
      if (this.luminary instanceof __WEBPACK_IMPORTED_MODULE_0__sun_js__["default"]) {
        this.luminary = new __WEBPACK_IMPORTED_MODULE_1__moon_js__["default"](this.canvas_width, this.canvas_height);
        this.cloudsImage.src = "./assets/sprites/clouds_night.png";
        this.mountainImage.src =  './assets/sprites/mountain_night.png';
      } else {
        this.luminary = new __WEBPACK_IMPORTED_MODULE_0__sun_js__["default"](this.canvas_width, this.canvas_height);
        this.cloudsImage.src = "./assets/sprites/clouds_day.png";
        this.mountainImage.src =  './assets/sprites/mountain_day.png';
  ...
  scrollImage() {
    if (this.slowMode) {
      this.cloudsX = this.cloudsX - .2 * slowModeSpeedReducer;
      this.starrySkyX = this.starrySkyX - .04 * slowModeSpeedReducer;
    } else {
  ...
  manageBirdCycle(ctx) {
    ...
    if (this.luminary instanceof __WEBPACK_IMPORTED_MODULE_1__moon_js__["default"]) {
      return;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__weapons_forcefield_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__weapons_bubble_shield_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__weapons_time_controller_js__ = __webpack_require__(21);
...
class Llama {
  constructor(canvas_width, canvas_height) {
    ...
    this.weaponTextDisplayColor = "blakc";
    this.walkcycle = 0;
  ...
  updateWeapons(ctx) {
    ...
    if (this.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_2__weapons_bubble_shield_js__["a" /* default */]) {
    ...
    } else if (this.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_3__weapons_time_controller_js__["a" /* default */]) {
      if (this.activatedWeaponCountDown < 0) {
        this.returnCurrentActivatedWeapon().status = "inactive";
        this.activatedWeaponCountDown = 16 * 60;
      } else {
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/miqueas/Desktop/Projects/little_llama_redo/lib/sun.js'\n    at Error (native)");

/***/ }),
/* 11 */
/***/ (function(module, exports) {

throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/miqueas/Desktop/Projects/little_llama_redo/lib/moon.js'\n    at Error (native)");
