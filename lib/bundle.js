...
class GameView {
  ...
  allowRestart() {
    ...
    // NOTE: Check the database, check to see if the database contains less than
    //10 saved high scores for the current mode. If yes, allow for saving
...
let soundMuted = true;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    canvasEl.width = _game_js__WEBPACK_IMPORTED_MODULE_1__["default"].DIM_X;
    canvasEl.height = _game_js__WEBPACK_IMPORTED_MODULE_1__["default"].DIM_Y;
    const demo = new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"]("", "background-demo");
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, demo, soundMuted);
    gameView.animate();
  });
...
// NOTE: normal mode start
  document.getElementById("normal-button").addEventListener("click", () => {
    ...
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"]("normal", "normal-play"), soundMuted);
    gameView.animate();
  });
...
// NOTE: flight mode start
  document.getElementById("flight-button").addEventListener("click", () => {
    ...
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"]("flightMode", "normal-play"), soundMuted);
    gameView.animate();
  });
...
// NOTE: Pause button
  ...
  document.getElementById("restart-button").addEventListener("click", () => {
    ...
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"]("", "background-demo"), soundMuted);
    gameView.animate();
  });
...
// NOTE: description animations
  ...
  let pausedBeforeClicked = false;
    ...
    document.getElementById("save-score-button").addEventListener("click", () => {
      ...
      let ref = gameView.game.gameMode === "normal" ? database.ref('scores/normalMode') : database.ref('scores/flightMode');
