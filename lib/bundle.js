...
class Game {
  constructor() {
    ...
    this.itemsInPlay = [new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 300, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "bubbleShield"),
    new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](300, 100, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"), new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](300, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast")
    ]
...
// NOTE: Miscellaneous functions
  ...
  returnEmptySpawnCircle() {
    ...
    let objects = [].concat(this.llama).concat(this.pigs).concat(this.itemsInPlay);
...
class Llama {
  ...
  updateWeapons(ctx) {
    ...
    if (this.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_2__weapons_bubble_shield_js__["a" /* default */]) {
      console.log(this.activatedWeaponCountDown / 60)
