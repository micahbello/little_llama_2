...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__weapons_pig_speed_limiter_js__ = __webpack_require__(20);
...
class Game {
  constructor() {
    ...
    // ];
    this.itemsInPlay = [new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 300, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "pigSpeedLimiter"),
    new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 300, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "pigSpeedLimiter"),new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 300, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "pigSpeedLimiter"),
...
// NOTE: General flow functions
  update(ctx) {
    ...
    if (this.background.luminary instanceof __WEBPACK_IMPORTED_MODULE_11__sun_js__["a" /* default */]) {
  ...
  drawScore(ctx) {
    let outlineColor = this.background.luminary instanceof __WEBPACK_IMPORTED_MODULE_11__sun_js__["a" /* default */] ? "black" : "white"
  ...
  drawWeaponsContainer(ctx) {
    ...
    if (this.llama.weaponsInPossession[0]) {
      ...
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_10__weapons_pig_speed_limiter_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 0) {
...
// NOTE: Miscellaneous functions
  ...
  convertCollectedWeaponToLlamaWeapon(weaponType) {
    if (weaponType === "forceFieldBlast"){
      ...
      this.llama.weaponsInPossession.push(new __WEBPACK_IMPORTED_MODULE_10__weapons_pig_speed_limiter_js__["a" /* default */]());
    }
  }
...
// NOTE: Currently not being used
  ...
  managePigsPlatformsWhenPigSpeedLimiterIsActive() {
    let pigLimiterActive =  this.llama.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_10__weapons_pig_speed_limiter_js__["a" /* default */];
    ...
    objects.forEach(object => {
      ...
      } else if (object instanceof __WEBPACK_IMPORTED_MODULE_2__platform_js__["a" /* default */]) {
        if (pigLimiterActive) {
          object.slowMode = true;
        } else {
          object.slowMode = false;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__weapons_pig_speed_limiter_js__ = __webpack_require__(20);
...
class Llama {
  ...
  updateWeapons(ctx) {
    ...
    } else if (this.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_3__weapons_pig_speed_limiter_js__["a" /* default */]) {
      if (this.activatedWeaponCountDown < 0) {
        this.returnCurrentActivatedWeapon().status = "inactive";
        this.activatedWeaponCountDown = 16 * 60;
      } else {
        ...
        ctx.fillStyle = countDownColor;
        ctx.textAlign="right";
        ctx.fillText(`Pig Speed Limiter: ${Math.trunc(this.activatedWeaponCountDown / 60)}`, 570, 45);
        this.activatedWeaponCountDown --;
      }
    }
...
class Platform {
  constructor(direction, trackNumber, x, y, speed) {
    ...
    this.height = 22;
    this.width = 124;
    this.reducedSpeed = this.speed * .5;
    this.slowMode = false;
...
class WeaponItem {
  ...
  draw(ctx) {
    ...
    } else if (this.type === "pigSpeedLimiter") {
...
/* harmony default export */ __webpack_exports__["a"] = (PigSpeedLimiter);
