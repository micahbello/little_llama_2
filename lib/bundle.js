...
// NOTE: General flow functions
  ...
  drawWeaponsContainer(ctx) {
    ...
    //and the size of the icon
        // ctx.beginPath();
        // ctx.arc(WEAPON1COORD.x, WEAPON1COORD.y, 24, 0, Math.PI*2);
        // ctx.fillStyle = "black";
        // ctx.fill();
        // ctx.closePath();
        //
        // ctx.beginPath();
        // ctx.arc(WEAPON2COORD.x, WEAPON2COORD.y, 24, 0, Math.PI*2);
        // ctx.fillStyle = "black";
        // ctx.fill();
        // ctx.closePath();
        //
        // ctx.beginPath();
        // ctx.arc(WEAPON3COORD.x, WEAPON3COORD.y, 24, 0, Math.PI*2);
        // ctx.fillStyle = "black";
        // ctx.fill();
        // ctx.closePath();
    //
    ...
    if (this.llama.weaponsInPossesion[0]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, WEAPON1COORD.x - 26, WEAPON1COORD.y - 24, 63, 63);
      }
    }
    ...
    if (this.llama.weaponsInPossesion[1]) {
      let weapon = this.llama.weaponsInPossesion[0];
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, WEAPON2COORD.x - 26, WEAPON2COORD.y - 24, 63, 63);
      }
    }
    ...
    if (this.llama.weaponsInPossesion[1]) {
      let weapon = this.llama.weaponsInPossesion[0];
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, WEAPON3COORD.x - 26, WEAPON3COORD.y - 24, 63, 63);
      }
    }
  }
