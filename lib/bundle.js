...
class Llama {
  ...
  draw(ctx) {
    ...
    ctx.fill();
      ...
      // let forceFieldGradient = ctx.createRadialGradient(500, 250, 100, 600, 250, 200);
      // forceFieldGradient.addColorStop(0, 'white');
      // forceFieldGradient.addColorStop(1, 'blue');
      // ctx.beginPath();
