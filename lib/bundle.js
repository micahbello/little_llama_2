...
class Game {
  constructor() {
    ...
    this.itemsInPlay = [new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"), new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](300, 100, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"), new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](300, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast")]
      ...
      if (this.itemsInPlay[i].status === "available") {
        ...
        if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */]) {
          ...
          if (this.llama.forceFieldOn === true) {
            if (this.areSpheresColliding(this.llama.forceField, this.itemsInPlay[i])) {
