...
const WEAPON1COORD = {x: 575, y: 5};
const WEAPON2COORD = {x: 630, y: 5};
const WEAPON3COORD = {x: 685, y: 5};

const WEAPONSCONTAINERCOORDS = [
  WEAPON1COORD,
  WEAPON2COORD,
  WEAPON3COORD
];
...
class Game {
  constructor() {
    ...
    this.itemsInPlay = [new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"),new __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */](Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT)];
      ...
      if (this.itemsInPlay[i].status === "available") {
        ...
        if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_3__pig_js__["a" /* default */]) {
          ...
          if (this.areSphereNonSphereColliding(this.itemsInPlay[i], this.llama)) {
            ...
            this.llama.weaponsInPossesion.push(this.itemsInPlay[i]);
            this.resolveLlamaItemsWithDepositSpacesCollision(this.itemsInPlay[i]);
          }
        }
      }
...
/* unused harmony default export */ var _unused_webpack_default_export = (ForceField);
