...
let soundMuted = true;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const demo = new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"]("normal", "background-demo");
...
// NOTE: Pause button
  ...
  document.getElementById("restart-button").addEventListener("click", () => {
    ...
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, new _game_js__WEBPACK_IMPORTED_MODULE_1__["default"]("normal", "background-demo"), soundMuted);
    gameView.animate();
  });
