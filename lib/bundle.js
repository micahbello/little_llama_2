...
class Game {
  constructor() {
    ...
    this.pig = new __WEBPACK_IMPORTED_MODULE_2__pig_js__["a" /* default */](Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT);
    this.pig2 = new __WEBPACK_IMPORTED_MODULE_2__pig_js__["a" /* default */](Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT);
...
/* unused harmony default export */ var _unused_webpack_default_export = (Cloud);
...
class Pig {
  constructor(canvas_width, canvas_height) {
    ...
    this.spritesheet = new Image();
    this.spritesheet.src = './assets/sprites/pig_sprites.png';
  }
