...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background_background_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__animals_llama_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__other_objects_platform_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__animals_pig_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__other_objects_bacon_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__weapons_time_controller_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__background_sun_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__background_bird_1_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__constants_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__util_js__ = __webpack_require__(20);
...
class Game extends __WEBPACK_IMPORTED_MODULE_14__util_js__["a" /* default */] {
  constructor() {
    ...
    // ];
    this.itemsInPlay = [new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](600, 300, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "timeController"),
    ...
    new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](300, 100, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "bubbleShield"), new __WEBPACK_IMPORTED_MODULE_7__special_items_weapon_items_js__["a" /* default */](300, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast")
    ]
...
// NOTE: General flow functions
  ...
  showSpawnCircles(ctx) {
    __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */].forEach(set => {
      ctx.beginPath();
  ...
  manageInactiveAndDiscardedItems() {
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      if (this.itemsInPlay[i] instanceof __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__["a" /* default */]) {
        if (this.itemsInPlay[i].status === "inactive") {
          ...
          if (this.itemsInPlay[i].x < __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].x + this.itemsInPlay[i].radius && this.itemsInPlay[i].y < __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].y + this.itemsInPlay[i].radius) {
    ...
    for (let i = 0; i < this.coins.length; i++) {
      if (this.coins[i].status === "inactive") {
        ...
        if ((this.coins[i].x < __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].x && this.coins[i].y < __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].y) || (this.coins[i].x < -10) || (this.coins[i].y < -10)) {
  ...
  managePlatforms() {
    ...
    if (!(this.platforms.length > 12)) {
      ...
      __WEBPACK_IMPORTED_MODULE_13__constants_js__["j" /* PLATFORMTRACKS */].forEach((trackset) => {
  ...
  drawScore(ctx) {
    ...
    //coin
    ctx.drawImage(this.coinIcon, 0, 0, 35, 35, __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].x, __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].y, 26, 26);
    ctx.font = `17px ${__WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* CANVAS_FONT */]}`;
    ctx.textAlign = "left"
    ctx.fillStyle = outlineColor
    ctx.fillText(`x ${this.scoreOnCounter}`, __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].x + 25, __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].y + 15);

    //heart
    ctx.drawImage(this.heartIcon, 0, 0, 30, 30, __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].x, __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].y, 28, 28);
    ctx.font = `17px ${__WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* CANVAS_FONT */]}`;
    ctx.fillStyle = outlineColor;
    ctx.fillText(`x ${this.llamaHeartsOnCounter}`, __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].x + 32, __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].y + 15);
    ...
    //seconds elapsed
    ctx.font = `14px ${__WEBPACK_IMPORTED_MODULE_13__constants_js__["c" /* CANVAS_FONT */]}`;
    ctx.fillStyle = outlineColor;
    ctx.textAlign="right";
    ...
    if (this.llama.weaponsInPossession[0]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 0) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].y - 22, 48, 48);
        }
        ...
        if (this.llama.weaponTogglePosition === 0) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */].y - 24, 50, 50);
        }
      }
    }
    ...
    if (this.llama.weaponsInPossession[1]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 1) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].y - 22, 48, 48);
        }
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 1) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].y - 22, 58, 58);
        ...
        if (this.llama.weaponTogglePosition === 1) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */].y - 24, 50, 50);
        }
      }
    }
    ...
    if (this.llama.weaponsInPossession[2]) {
      ...
      if (weapon instanceof __WEBPACK_IMPORTED_MODULE_8__weapons_forcefield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 2) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].y - 22, 48, 48);
        }
      } else if (weapon instanceof __WEBPACK_IMPORTED_MODULE_9__weapons_bubble_shield_js__["a" /* default */]) {
        if (this.llama.weaponTogglePosition === 2) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].x - 24, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].y - 22, 58, 58);
        ...
        if (this.llama.weaponTogglePosition === 2) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].x - 17, __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */].y - 24, 50, 50);
        }
      }
    }
  }
      ...
      if (llamaFront > platform.x && this.llama.x < platformFront &&  llamaBottom < platformBottom && platform.y < llamaBottom && this.llama.y_velocity > 0) {
        ...
        if (platform.direction === "right") {
          ...
          if (this.llama.returnCurrentActivatedWeapon() instanceof __WEBPACK_IMPORTED_MODULE_10__weapons_time_controller_js__["a" /* default */]) {
            this.llama.x += platform.speed * __WEBPACK_IMPORTED_MODULE_13__constants_js__["o" /* slowModeSpeedReducer */];
          } else {
  ...
  resolveLlamaItemsWithDepositSpacesCollision(object) {
    ...
    if (object instanceof __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__["a" /* default */]) {
      destination.x = __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].x;
      destination.y = __WEBPACK_IMPORTED_MODULE_13__constants_js__["d" /* COINDEPOSITCOORD */].y;
    } else if (object instanceof __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__["a" /* default */]) {
      destination.x = __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].x;
      destination.y = __WEBPACK_IMPORTED_MODULE_13__constants_js__["f" /* HEARTDEPOSITCOORD */].y;
...
// NOTE: Miscellaneous functions
  ...
  returnEmptyWeaponSlot() {
    if (this.llama.weaponsInPossession.length === 0) {
      return __WEBPACK_IMPORTED_MODULE_13__constants_js__["l" /* WEAPON1COORD */];
    } else if (this.llama.weaponsInPossession.length === 1) {
      return __WEBPACK_IMPORTED_MODULE_13__constants_js__["m" /* WEAPON2COORD */];
    } else if (this.llama.weaponsInPossession.length === 2) {
      return __WEBPACK_IMPORTED_MODULE_13__constants_js__["n" /* WEAPON3COORD */];
    }
  }
  ...
  returnEmptySpawnCircle() {
    ...
    for (let i = 0; i < __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */].length; i++) {
      for (let j = 0; j < objects.length; j++) {
        if (objects[j] instanceof __WEBPACK_IMPORTED_MODULE_3__animals_pig_js__["a" /* default */]){

          if (this.areSpheresColliding({x: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][0], y: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][1], radius: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][2]}, objects[j]) && (objects[j].status === "available" || objects[j].status === "testing")) {
            circles[i] = false;
          }
        } else if (objects[j] instanceof __WEBPACK_IMPORTED_MODULE_1__animals_llama_js__["a" /* default */]) {
          if (this.areSphereNonSphereColliding({x: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][0], y: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][1], radius: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][2]}, objects[j])) {
            circles[i] = false;
          }
        } else if (objects[j] instanceof __WEBPACK_IMPORTED_MODULE_5__other_objects_heart_js__["a" /* default */]) {
          if (this.areSpheresColliding({x: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][0], y: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][1], radius: __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i][2]}, objects[j])) {
            circles[i] = false;
          }
        }
      }
    ...
    for (let i = 0; i < circles.length; i++) {
      if (circles[i] === true) {
        return __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][i];
      }
    }

    return __WEBPACK_IMPORTED_MODULE_13__constants_js__["k" /* SPAWNCIRCLES */][0];
  }
      ...
      if (slowModeOn) {
        if (object instanceof __WEBPACK_IMPORTED_MODULE_4__other_objects_coin_js__["a" /* default */] || object instanceof __WEBPACK_IMPORTED_MODULE_12__background_bird_1_js__["a" /* default */]) {
          if (!object.spritecycleOffsetForSlowMode) {
            object.spritecycle = object.spritecycle / __WEBPACK_IMPORTED_MODULE_13__constants_js__["o" /* slowModeSpeedReducer */];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__luminary_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__game_view_js__ = __webpack_require__(9);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sun_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__moon_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bird_1_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__meteor_js__ = __webpack_require__(12);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__weapons_forcefield_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__weapons_bubble_shield_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__weapons_time_controller_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__special_items_weapon_items_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constants_js__ = __webpack_require__(0);
