...
/* harmony import */ var _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../weapons/bullets_spray.js */ "./lib/weapons/bullets_spray.js");
/* harmony import */ var _special_items_weapon_items_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../special_items/weapon_items.js */ "./lib/special_items/weapon_items.js");
...
class Llama {
  constructor(canvas_width, canvas_height, mode, soundMutedBoolean) {
    ...
    this.bulletsInPlay = false;

    this.soundMuted = soundMutedBoolean;

    this.slowStartSound = new Audio("./assets/audio/slowstart.mp3");
    this.slowEndSound = new Audio("./assets/audio/slowend.mp3");
    this.bubbleStartSound = new Audio("./assets/audio/bubblestart.mp3");
    this.bubblePopSound = new Audio("./assets/audio/bubblepop.mp3");
    this.forceFieldSound = new Audio("./assets/audio/forcefield.mp3");
    this.weaponSwitchSound = new Audio("./assets/audio/weapon_switch.mp3");
    this.BulletSound = new Audio("./assets/audio/bullet_sound.mp3");
  ...
  getSprite() {
    ...
    if (this.status === "dead") {
      ...
      return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].dead;
    }
    ...
    if (!this.keysPressed[37] && !this.keysPressed[39] && this.jumping === false) {
      ...
      if (this.lastDirectionFaced === "right") {
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].rightPosition1
      } else if (this.lastDirectionFaced === "left") {
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].leftPosition1
      }
    }
    ...
    if (this.keysPressed[37]) {
      ...
      if (this.walkcycle < 6) {
        ...
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].leftPosition2
      } else if (this.walkcycle < 18) {
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].leftPosition3
      } else if (this.walkcycle < 24) {
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].leftPosition4
      } else {
        this.walkcycle = 0;
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].leftPosition1
      }
      ...
      if (this.walkcycle < 6) {
        ...
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].rightPosition2
      } else if (this.walkcycle < 18) {
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].rightPosition3
      } else if (this.walkcycle < 24) {
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].rightPosition4
      } else {
        this.walkcycle = 0;
        return _constants_js__WEBPACK_IMPORTED_MODULE_5__["LLAMA_SPRITES"].rightPosition1
      }
  ...
  keyUpHandler(e) {
    ...
    if (e.keyCode === 37) {
      ...
      //    return;
      // }
      if (!this.soundMuted && this.weaponsInPossession.length > 1) {
  ...
  activateWeapon(weaponIndex) {
    ...
    if (!this.soundMuted) {
      if (this.weaponsInPossession[weaponIndex] instanceof _weapons_time_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"]) {
        this.slowStartSound.play();
      } else if (this.weaponsInPossession[weaponIndex] instanceof _weapons_bubble_shield_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
        this.bubbleStartSound.play();
      } else if (this.weaponsInPossession[weaponIndex] instanceof _weapons_forcefield_js__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        this.forceFieldSound.play();
      } else if (this.weaponsInPossession[weaponIndex] instanceof _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_3__["default"]) {
  ...
  getRidOfWeapon(weaponIndex) {
    ...
    if (this.weaponsInPossession[weaponIndex].status === "activated") {
      ...
      this.weaponsDiscarded.push(new _special_items_weapon_items_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.x + (this.width/2), this.y + (this.height/2), this.canvas_width,
  ...
  updateWeapons(ctx) {
    ...
    if (this.returnCurrentActivatedWeapon() instanceof _weapons_bubble_shield_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
      if (this.activatedWeaponCountDown < 0) {
        ...
        //countdown display
        ctx.font = `20px ${_constants_js__WEBPACK_IMPORTED_MODULE_5__["CANVAS_FONT"]}`;
        let countDownColor = "";
    ...
    for (let i = 0; i < this.weaponsInPossession.length; i++) {
      if (this.weaponsInPossession[i].status === "inactive") {
        if (!this.soundMuted) {
          if (this.weaponsInPossession[i] instanceof _weapons_time_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"]) {
            this.slowEndSound.play();
          } else if (this.weaponsInPossession[i] instanceof _weapons_bubble_shield_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
...
/* harmony import */ var _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./weapons/bullets_spray.js */ "./lib/weapons/bullets_spray.js");
/* harmony import */ var _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./weapons/bullet.js */ "./lib/weapons/bullet.js");
/* harmony import */ var _background_sun_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./background/sun.js */ "./lib/background/sun.js");
/* harmony import */ var _background_bird_1_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./background/bird_1.js */ "./lib/background/bird_1.js");
/* harmony import */ var _special_items_weapons_container_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./special_items/weapons_container.js */ "./lib/special_items/weapons_container.js");
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./constants.js */ "./lib/constants.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./util.js */ "./lib/util.js");
...
class Game extends _util_js__WEBPACK_IMPORTED_MODULE_17__["default"] {
  constructor(mode, displayType, soundMutedBoolean) {
    super();
    ...
    this.llama = new _animals_llama_js__WEBPACK_IMPORTED_MODULE_1__["default"](Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, mode, soundMutedBoolean);
    ...
    this.platforms = [];
    this.itemsInPlay = [];
    this.weaponsContainer = new _special_items_weapons_container_js__WEBPACK_IMPORTED_MODULE_15__["default"](this.llama.weaponsInPossession, this.llama.weaponTogglePosition, "black", this.llama.activeWeaponIndex);
    ...
    this.pigOinkSound = new Audio("./assets/audio/pig_oink.mp3");
    this.baconIsGoodSound = new Audio("./assets/audio/bacon_is_good.mp3");
    this.powerSound = new Audio("./assets/audio/power.mp3");
    ...
    //   new WeaponItem(600, 300, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "timeController"),
    //   new WeaponItem(600, 25, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "forceFieldBlast"),
    //   new WeaponItem(600, 100, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "bulletsSpray")
    // ];
...
// NOTE: General flow functions
  update(ctx) {
    ...
    if (this.background.luminary instanceof _background_sun_js__WEBPACK_IMPORTED_MODULE_13__["default"]) {
    ...
    this.manageActiveBulletSprayWeapon();
  ...
  showSpawnCircles(ctx) {
    _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"].forEach(set => {
      ctx.beginPath();
  ...
  manageInactiveAndDiscardedItems() {
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      if (this.itemsInPlay[i] instanceof _other_objects_heart_js__WEBPACK_IMPORTED_MODULE_5__["default"]) {
        if (this.itemsInPlay[i].status === "inactive") {
          ...
          if (this.itemsInPlay[i].x < _constants_js__WEBPACK_IMPORTED_MODULE_16__["HEARTDEPOSITCOORD"].x + this.itemsInPlay[i].radius && this.itemsInPlay[i].y < _constants_js__WEBPACK_IMPORTED_MODULE_16__["HEARTDEPOSITCOORD"].y + this.itemsInPlay[i].radius) {
        ...
        if (this.itemsInPlay[i].status === "inactive") {
          ...
          if ((bacon.x < _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].x && bacon.y < _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].y) || (bacon.x < -10) || (bacon.y < -10)) {
            this.itemsInPlay.splice(i, 1);
            this.baconsOnCounter ++;
            this.baconsCollectedTotal ++;
          }
        }
        ...
        if (this.itemsInPlay[i].status === "inactive" || this.itemsInPlay[i].type != "normal") {
          if (this.itemsInPlay[i].x < - 50 || this.itemsInPlay[i].x > Game.DIM_X + 50 || this.itemsInPlay[i].y < -50 || this.itemsInPlay[i].y > this.llama.canvas_height + 50) {
            this.itemsInPlay.splice(i, 1);
          }
        }
      } else if (this.itemsInPlay[i] instanceof _special_items_weapon_items_js__WEBPACK_IMPORTED_MODULE_7__["default"] || this.itemsInPlay[i] instanceof _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"]) {
        if (this.itemsInPlay[i].x < - 50 || this.itemsInPlay[i].x > Game.DIM_X + 50 || this.itemsInPlay[i].y < -50 || this.itemsInPlay[i].y > this.llama.canvas_height + 50) {
          this.itemsInPlay.splice(i, 1);
        }
      }
    ...
    for (let i = 0; i < this.coins.length; i++) {
      if (this.coins[i].status === "inactive") {
        ...
        if ((this.coins[i].x < _constants_js__WEBPACK_IMPORTED_MODULE_16__["COINDEPOSITCOORD"].x && this.coins[i].y < _constants_js__WEBPACK_IMPORTED_MODULE_16__["COINDEPOSITCOORD"].y) || (this.coins[i].x < -10) || (this.coins[i].y < -10)) {
  ...
  managePlatforms() {
    ...
    if (!(this.platforms.length > 12)) {
      ...
      _constants_js__WEBPACK_IMPORTED_MODULE_16__["PLATFORMTRACKS"].forEach((trackset) => {
  ...
  checkObjectCollisions() {
    ...
    this.checkPigAndBulletsCollisions();
  }
  ...
  updateDocumentSideStats() {
    ...
    document.getElementById("current-bacon-count").innerHTML = `${this.baconsCollectedTotal} (total)`;
    document.getElementById("current-mode").innerHTML = `mode: ${this.gameMode}`;
  }
  ...
  updateObjects(ctx) {
    ...
    this.allObjects().forEach(object => {
      if (object instanceof _special_items_weapons_container_js__WEBPACK_IMPORTED_MODULE_15__["default"]) {
        ...
        object.outlineColor = this.background.luminary instanceof _background_sun_js__WEBPACK_IMPORTED_MODULE_13__["default"] ? "black" : "white";
      }
  ...
  drawScore(ctx) {
    let outlineColor = this.background.luminary instanceof _background_sun_js__WEBPACK_IMPORTED_MODULE_13__["default"] ? "black" : "white"

    //coin
    ctx.drawImage(this.coinIcon, 0, 0, 35, 35, _constants_js__WEBPACK_IMPORTED_MODULE_16__["COINDEPOSITCOORD"].x, _constants_js__WEBPACK_IMPORTED_MODULE_16__["COINDEPOSITCOORD"].y, 26, 26);
    ctx.font = `17px ${_constants_js__WEBPACK_IMPORTED_MODULE_16__["CANVAS_FONT"]}`;
    ctx.textAlign = "left"
    ctx.fillStyle = outlineColor
    ctx.fillText(`x ${this.scoreOnCounter}`, _constants_js__WEBPACK_IMPORTED_MODULE_16__["COINDEPOSITCOORD"].x + 25, _constants_js__WEBPACK_IMPORTED_MODULE_16__["COINDEPOSITCOORD"].y + 15);

    //heart
    ctx.drawImage(this.heartIcon, 0, 0, 30, 30, _constants_js__WEBPACK_IMPORTED_MODULE_16__["HEARTDEPOSITCOORD"].x, _constants_js__WEBPACK_IMPORTED_MODULE_16__["HEARTDEPOSITCOORD"].y, 28, 28);
    ctx.font = `17px ${_constants_js__WEBPACK_IMPORTED_MODULE_16__["CANVAS_FONT"]}`;
    ctx.fillStyle = outlineColor;
    ctx.fillText(`x ${this.llamaHeartsOnCounter}`, _constants_js__WEBPACK_IMPORTED_MODULE_16__["HEARTDEPOSITCOORD"].x + 32, _constants_js__WEBPACK_IMPORTED_MODULE_16__["HEARTDEPOSITCOORD"].y + 15);

    //bacons
    ctx.drawImage(this.baconIcon, 10, 10, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].x, _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].y, 50, 50);
    ctx.font = `17px ${_constants_js__WEBPACK_IMPORTED_MODULE_16__["CANVAS_FONT"]}`;
    ctx.fillStyle = outlineColor;
    ctx.fillText(`x ${this.baconsOnCounter}`, _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].x + 43, _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].y + 15);

    //seconds elapsed
    ctx.font = `14px ${_constants_js__WEBPACK_IMPORTED_MODULE_16__["CANVAS_FONT"]}`;
    ctx.fillStyle = outlineColor;
    ctx.textAlign="right";
  ...
  updateBaconToHearts(ctx) {
    if (this.baconsOnCounter === 5) {
      ...
      let heartFromBacon = new _other_objects_heart_js__WEBPACK_IMPORTED_MODULE_5__["default"](_constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].x, _constants_js__WEBPACK_IMPORTED_MODULE_16__["BACONDEPOSITCOORD"].y, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "inactive");
      ...
      if (llamaFront > platform.x && this.llama.x < platformFront &&  llamaBottom < platformBottom && platform.y < llamaBottom && this.llama.y_velocity > 0) {
        ...
        if (platform.direction === "right") {
          ...
          if (this.llama.returnCurrentActivatedWeapon() instanceof _weapons_time_controller_js__WEBPACK_IMPORTED_MODULE_10__["default"]) {
            this.llama.x += platform.speed * _constants_js__WEBPACK_IMPORTED_MODULE_16__["slowModeSpeedReducer"];
          } else {
  ...
  checkPigAndBulletsCollisions() {
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      for (let j = 0; j < this.itemsInPlay.length; j++) {
        if (this.itemsInPlay[i] instanceof _animals_pig_js__WEBPACK_IMPORTED_MODULE_3__["default"] && this.itemsInPlay[i].status === "available" && this.itemsInPlay[j] instanceof _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"]) {
          if (this.areSpheresColliding(this.itemsInPlay[i], this.itemsInPlay[j])) {
            if (this.itemsInPlay[i].type != "normal") {
              this.itemsInPlay.push(new _other_objects_heart_js__WEBPACK_IMPORTED_MODULE_5__["default"](this.itemsInPlay[i].x - this.itemsInPlay[i].radius, this.itemsInPlay[i].y - this.itemsInPlay[i].radius, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT));
            }
...
// NOTE: Miscellaneous functions
  ...
  convertCollectedWeaponToLlamaWeapon(weaponType) {
    ...
    } else if (weaponType === "bulletsSpray") {
      this.llama.weaponsInPossession.push(new _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_11__["default"]());
    }
  }
  ...
  returnEmptySpawnCircle() {
    ...
    for (let i = 0; i < _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"].length; i++) {
      for (let j = 0; j < objects.length; j++) {
        if (objects[j] instanceof _animals_pig_js__WEBPACK_IMPORTED_MODULE_3__["default"]){

          if (this.areSpheresColliding({x: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][0], y: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][1], radius: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][2]}, objects[j]) && (objects[j].status === "available" || objects[j].status === "testing")) {
            circles[i] = false;
          }
        } else if (objects[j] instanceof _animals_llama_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
          if (this.areSphereNonSphereColliding({x: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][0], y: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][1], radius: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][2]}, objects[j])) {
            circles[i] = false;
          }
        } else if (objects[j] instanceof _other_objects_heart_js__WEBPACK_IMPORTED_MODULE_5__["default"]) {
          if (this.areSpheresColliding({x: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][0], y: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][1], radius: _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i][2]}, objects[j])) {
            circles[i] = false;
          }
        }
      }
    ...
    for (let i = 0; i < circles.length; i++) {
      if (circles[i] === true) {
        return _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][i];
      }
    }

    return _constants_js__WEBPACK_IMPORTED_MODULE_16__["SPAWNCIRCLES"][0];
  }
  ...
  spawnNewWeaponItem() {
    let randomDayWeapons = ["forceFieldBlast", "timeController", "bubbleShield", "bulletsSpray"];
    let randomNightWeapons = ["bubbleShield", "forceFieldBlast", "timeController", "bulletsSpray"];
  ...
  manageObjectsWhenInSlowMode() {
    ...
    objects.forEach(object => {
      if (slowModeOn && this.llama.status != "dead") {
        if (object instanceof _other_objects_coin_js__WEBPACK_IMPORTED_MODULE_4__["default"] || object instanceof _background_bird_1_js__WEBPACK_IMPORTED_MODULE_14__["default"]) {
          if (!object.spritecycleOffsetForSlowMode) {
            object.spritecycle = object.spritecycle / _constants_js__WEBPACK_IMPORTED_MODULE_16__["slowModeSpeedReducer"];
  ...
  manageActiveBulletSprayWeapon() {
    if (!(this.llama.returnCurrentActivatedWeapon() instanceof _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_11__["default"])) {
      return
    }


    if (this.llama.bulletsInPlay === false) {
      this.llama.bulletsInPlay = true;

      let llamaCircleX = this.llama.x + (this.llama.width/2);
      let llamaCircleY = this.llama.y + (this.llama.height/2);
      //there is an imaginary circle surrounding the llama. It has a radius of 30 px;

      //
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](3, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(0, 30), llamaCircleY + this.getCircleY(0, 30))); // bullet at 3 o'clock
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](10, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(210, 30), llamaCircleY + this.getCircleY(210, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](6, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(90, 30), llamaCircleY + this.getCircleY(90, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](12, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(270, 30), llamaCircleY + this.getCircleY(270, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](9, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(180, 30), llamaCircleY + this.getCircleY(180, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](4, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(30, 30), llamaCircleY + this.getCircleY(30, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](5, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(60, 30), llamaCircleY + this.getCircleY(60, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](1, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(300, 30), llamaCircleY + this.getCircleY(300, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](2, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(330, 30), llamaCircleY + this.getCircleY(330, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](11, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(240, 30), llamaCircleY + this.getCircleY(240, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](7, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(120, 30), llamaCircleY + this.getCircleY(120, 30)));
      this.itemsInPlay.push(new _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"](8, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(150, 30), llamaCircleY + this.getCircleY(150, 30)));

    }

    if (!(this.itemsInPlay.some((item) => item instanceof _weapons_bullet_js__WEBPACK_IMPORTED_MODULE_12__["default"]))) {
      this.llama.returnCurrentActivatedWeapon().status = "inactive";
      this.llama.bulletsInPlay = false;
    }
  }

  getCircleX(angle, radius) {
  ...
  keyDownHandler(e) {
    if (e.keyCode === 80) { //the letter p
      ...
      if (this.game.gameOver === true) {
        ...
        this.game = new _game_js__WEBPACK_IMPORTED_MODULE_0__["default"](mode, "normal-play", newSoundBoolean);
...
const QUICK_TIPS = [
  ...
  "It is a good strategy to use Bubble Shield or Time Controller to collect as many coins as possible...",
  "And then to immediately use Bullet Spray or Force Field Blast to handle all the accumulated pigs"
];
...
let soundMuted = true;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const demo = new _game_js__WEBPACK_IMPORTED_MODULE_2__["default"]("", "background-demo", soundMuted);
...
// NOTE: normal mode start
  document.getElementById("normal-button").addEventListener("click", () => {
    ...
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, new _game_js__WEBPACK_IMPORTED_MODULE_2__["default"]("normal", "normal-play", soundMuted), soundMuted);
    gameView.animate();
  });
...
// NOTE: flight mode start
  document.getElementById("flight-button").addEventListener("click", () => {
    ...
    gameView = new _game_view_js__WEBPACK_IMPORTED_MODULE_1__["default"](ctx, new _game_js__WEBPACK_IMPORTED_MODULE_2__["default"]("flightMode", "normal-play", soundMuted), soundMuted);
    gameView.animate();
  });

// NOTE: Pause button
  document.getElementById("pause-button").addEventListener("click", () => {
    if (gameView.game.status === "background-demo" || gameView.game.gameOver) {
      return;
    }
  ...
  document.getElementById("sound-button-off").addEventListener("click", () => {
    ...
    gameView.game.soundMuted = false;
    gameView.game.llama.soundMuted = false;
  });
  ...
  document.getElementById("sound-button-on").addEventListener("click", () => {
    ...
    gameView.game.soundMuted = true;
    gameView.game.llama.soundMuted = true;
  });
...
class WeaponItem {
  ...
  draw(ctx) {
    ...
    } else if (this.type === "bulletsSpray") {
      ctx.drawImage(this.weaponImage, 0, 0, 800, 800, this.x - 24, this.y - 24, 182, 182);
    }
  }
...
class WeaponsContainer {
  ...
  draw(ctx) {
    ...
    if (this.activeWeaponIndex[0] === -1) {
      ctx.beginPath();
      ctx.font = `18px ${_constants_js__WEBPACK_IMPORTED_MODULE_4__["CANVAS_FONT"]}`;
      ...
      } else if (this.equippedLLamaWeapons[this.weaponTogglePosition] instanceof _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_3__["default"]) {
    ...
    if (this.equippedLLamaWeapons[0]) {
      ...
      if (weapon instanceof _weapons_forcefield_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 22, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 22, 50, 50);
        }

      } else if (weapon instanceof _weapons_bubble_shield_js__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 22, 48, 48);
        }
      } else if (weapon instanceof _weapons_time_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 24, 50, 50);
        }
      } else if (weapon instanceof _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_3__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 20, 170, 170);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON1COORD"].y - 20, 150, 150);
        }
      }
    }
    ...
    if (this.equippedLLamaWeapons[1]) {
      ...
      if (weapon instanceof _weapons_forcefield_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 22, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 22, 50, 50);
        }
      } else if (weapon instanceof _weapons_bubble_shield_js__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 22, 48, 48);
        }
      } else if (weapon instanceof _weapons_time_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 24, 50, 50);
        }
      } else if (weapon instanceof _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_3__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 20, 170, 170);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON2COORD"].y - 20, 150, 150);
        }
      }
    }
    ...
    if (this.equippedLLamaWeapons[2]) {
      ...
      if (weapon instanceof _weapons_forcefield_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 22, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 22, 50, 50);
        }
      } else if (weapon instanceof _weapons_bubble_shield_js__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 22, 58, 58);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 300, 300, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 24, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 22, 48, 48);
        }
      } else if (weapon instanceof _weapons_time_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 24, 60, 60);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 24, 50, 50);
        }
      } else if (weapon instanceof _weapons_bullets_spray_js__WEBPACK_IMPORTED_MODULE_3__["default"]) {
        if (isIndexToggled) {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 20, 170, 170);
        } else {
          ctx.drawImage(weapon.weaponImage, 0, 0, 800, 800, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].x - 17, _constants_js__WEBPACK_IMPORTED_MODULE_4__["WEAPON3COORD"].y - 20, 150, 150);
        }
      }
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (BulletsSpray);
