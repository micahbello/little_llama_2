...
class Llama {
  ...
  activateWeapon(weaponIndex) {
    ...
    if (!this.soundMuted) {
      if (this.weaponsInPossession[weaponIndex] instanceof TimeController) {
        this.slowStartSound.play();
      } else if (this.weaponsInPossession[weaponIndex] instanceof BubbleShield) {
        this.bubbleStartSound.play();
      } else if (this.weaponsInPossession[weaponIndex] instanceof ForceField) {
        this.forceFieldSound.play();
      } else if (this.weaponsInPossession[weaponIndex] instanceof BulletsSpray) {
  ...
  updateWeapons(ctx) {
    ...
    for (let i = 0; i < this.weaponsInPossession.length; i++) {
      if (this.weaponsInPossession[i].status === "inactive") {
        if (!this.soundMuted) {
          if (this.weaponsInPossession[i] instanceof TimeController) {
            this.slowEndSound.play();
          } else if (this.weaponsInPossession[i] instanceof BubbleShield) {
