...
let soundMuted = true;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const demo = new Game("", "background-demo", soundMuted);
...
// NOTE: normal mode start
  document.getElementById("normal-button").addEventListener("click", () => {
    ...
    gameView = new GameView(ctx, new Game("normal", "normal-play", soundMuted), soundMuted);
    gameView.animate();
  });
...
// NOTE: flight mode start
  document.getElementById("flight-button").addEventListener("click", () => {
    ...
    gameView = new GameView(ctx, new Game("flightMode", "normal-play", soundMuted), soundMuted);
    gameView.animate();
  });
