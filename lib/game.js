...
class Game {
  constructor() {
    ...
    this.pigs = [new Pig(20, 20, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "testing"), new Pig(700, 20, Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, "testing"),
    new Pig(Math.floor(Math.random() * 500), Math.floor(Math.random() * 300), Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT)];
    this.platforms = [];
