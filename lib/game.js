...
class Game extends Util {
  constructor(mode, displayType, soundMutedBoolean) {
    ...
    this.llama = new Llama(Game.DIM_X, Game.DIM_Y - Game.FLOOR_HEIGHT, mode, soundMutedBoolean);
...
// NOTE: General flow functions
  ...
  manageInactiveAndDiscardedItems() {
    ...
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      ...
      } else if (this.itemsInPlay[i] instanceof WeaponItem || this.itemsInPlay[i] instanceof Bullet) {
        if (this.itemsInPlay[i].x < - 50 || this.itemsInPlay[i].x > Game.DIM_X + 50 || this.itemsInPlay[i].y < -50 || this.itemsInPlay[i].y > this.llama.canvas_height + 50) {
          this.itemsInPlay.splice(i, 1);
        }
      }
  ...
  checkPigAndBulletsCollisions() {
    for (let i = 0; i < this.itemsInPlay.length; i++) {
      for (let j = 0; j < this.itemsInPlay.length; j++) {
        if (this.itemsInPlay[i] instanceof Pig && this.itemsInPlay[i].status === "available" && this.itemsInPlay[j] instanceof Bullet) {
...
// NOTE: Miscellaneous functions
  ...
  convertCollectedWeaponToLlamaWeapon(weaponType) {
    if (weaponType === "forceFieldBlast"){
      ...
      this.llama.weaponsInPossession.push(new BulletsSpray());
    }
  }
  ...
  manageActiveBulletSprayWeapon() {
    if (!(this.llama.returnCurrentActivatedWeapon() instanceof BulletsSpray)) {
      return
    }
    ...
    if (this.llama.bulletsInPlay === false) {
      ...
      //
      this.itemsInPlay.push(new Bullet(3, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(0, 30), llamaCircleY + this.getCircleY(0, 30))); // bullet at 3 o'clock
      this.itemsInPlay.push(new Bullet(10, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(210, 30), llamaCircleY + this.getCircleY(210, 30)));
      this.itemsInPlay.push(new Bullet(6, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(90, 30), llamaCircleY + this.getCircleY(90, 30)));
      this.itemsInPlay.push(new Bullet(12, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(270, 30), llamaCircleY + this.getCircleY(270, 30)));
      this.itemsInPlay.push(new Bullet(9, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(180, 30), llamaCircleY + this.getCircleY(180, 30)));
      this.itemsInPlay.push(new Bullet(4, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(30, 30), llamaCircleY + this.getCircleY(30, 30)));
      this.itemsInPlay.push(new Bullet(5, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(60, 30), llamaCircleY + this.getCircleY(60, 30)));
      this.itemsInPlay.push(new Bullet(1, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(300, 30), llamaCircleY + this.getCircleY(300, 30)));
      this.itemsInPlay.push(new Bullet(2, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(330, 30), llamaCircleY + this.getCircleY(330, 30)));
      this.itemsInPlay.push(new Bullet(11, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(240, 30), llamaCircleY + this.getCircleY(240, 30)));
      this.itemsInPlay.push(new Bullet(7, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(120, 30), llamaCircleY + this.getCircleY(120, 30)));
      this.itemsInPlay.push(new Bullet(8, 30, llamaCircleX, llamaCircleY, llamaCircleX + this.getCircleX(150, 30), llamaCircleY + this.getCircleY(150, 30)));

    }

    if (!(this.itemsInPlay.some((item) => item instanceof Bullet))) {
