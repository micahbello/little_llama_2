...
import {slowModeSpeedReducer, PLATFORMTRACKS, SPAWNCIRCLES, COINDEPOSITCOORD,
        HEARTDEPOSITCOORD, BACONDEPOSITCOORD, WEAPON1COORD, WEAPON2COORD,
        WEAPON3COORD} from './constants.js';
...
// NOTE: Miscellaneous functions
  ...
  managePigsPlatformsWhenTimeControllerIsActive() {
    let pigLimiterActive =  this.llama.returnCurrentActivatedWeapon() instanceof TimeController;
